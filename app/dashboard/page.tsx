              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {registeredEvents.map((registration) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold mb-2 text-blue-300">{events[registration.event_id-1].title}</h3>
                    <div 
                      className="h-1 w-10 rounded mb-3 transition-all duration-300 group-hover:w-3/4"
                      style={{ background: `linear-gradient(to right, ${events[registration.event_id-1].color || '#4fd1c5'}, #805ad5)` }}  
                    ></div>
                    <p className="text-blue-100/70 text-sm mb-4">{events[registration.event_id-1].description?.substring(0, 100)}...</p>
